...
export default function Home() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4, backgroundColor: "#242323" }}>
      <ToastContainer />
      <Box sx={{ backgroundColor: "#6440db", padding: 4, borderRadius: 2, boxShadow: 3 }}>
        <Typography variant="h2" align="center" color="yellow" gutterBottom>
        ...
        <Box mb={4}>
          <Typography variant="h4" gutterBottom color="pink">
            Completed Tasks
          </Typography>
          <Box display="flex" flexWrap="wrap" gap={2}>
